  ...
  return (
    <div className='container content'>
      <p className='intro'>
        ...
        <a href='https://www.beeminder.com/home'>Beeminder</a> to be the service
        that works best for me. However, it's very limited in certain ways.
        Luckily Beeminder has an API that has allowed me to expand its
        functionality.
      </p>
      <p className='intro'>
        <a href='https://github.com/travisbostick/notionminder'>Notionminder</a>{' '}
        is a NodeJS and iOS shortcut tool I made that takes all of the words in
        a Notion databases and sends the total count to Beeminder, allowing
        someone to conveniently track their progress on a Notion journal. To
        further improve the Notion journaling experience, I also created another{' '}
