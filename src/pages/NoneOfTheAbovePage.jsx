...
function NoneOfTheAbovePage() {
  return (
    <div className='container content mt-1'>
      <FadeIn>
        <h1 className='mb-3 doc-title'>
          <i>None of the Above</i>
        </h1>
        <p className='intro'>
          In Summer 2018, I directed and edited a documentary about the Atlanta
          Public Schools cheating scandal. The short film was made within the
          span of one month with no budget and camera equipment borrowed from
          the school.
        </p>
