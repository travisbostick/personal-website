      ...
      <FadeIn>
        <div className='row mb-5'>
          <p className='col intro mt-auto mb-auto'>
            I designed and did most of the development for <i>IQBank</i>, which
            is an interactive question bank for professors to view, enter, edit,
        ...
        <div className='row mb-5'>
          <p className='col intro mt-auto mb-auto'>
            The web app features a robust authentication system as well as
            support for text formatting among its many features.
          </p>
          <img
            className='col big-image'
        ...
        <p className='intro'>
          ...
          React Testing Library, Auth0, DraftJS, SemanticUI, Bootstrap, and
          React Table.
        </p>
      </FadeIn>
    </div>
